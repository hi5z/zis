...
echo '<a class="zagr" href="/cat.php">Рейтинг категорий</a>&nbsp;&nbsp;';
echo '</div>';
...
<a class="zagr" href="/cat.php">Рейтинг категорий</a>&nbsp;&nbsp;
</div>
...
echo <<<HTML
   <div style="float: left;">
<a class="zagr" href="/">Главная</a>&nbsp;&nbsp;
<a class="zagr" href="/admin.php">Админка</a>&nbsp;&nbsp;
<a class="zagr" href="/settings.php">Настройки</a>&nbsp;&nbsp;
