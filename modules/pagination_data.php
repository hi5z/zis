    ...
    <?php
        ...
        while ($row = mysql_fetch_array($rsd)) {
            ...
            <tr>
                ...
                <td align="center"><a target="_blank" href="<?php echo $url . $link; ?>"><img height="150px"
                                                                                              src="<?php echo $url . $papka . $link . '.' . $exten; ?>"/></a>
                </td>
                <td align="center">
                    Имя файла: <?php echo $name; ?><br/>
                    Кто загрузил: <?php if ($owner != NULL) {
                        echo $owner;
                    } else {
                        echo Anonymous;
                    } ?> (<a target="_blank" href="http://ip-lookup.net/index.php?ip=<?php echo $ip; ?>"
                             title="IP адрес"><?php echo $ip; ?></a>)<br/>
